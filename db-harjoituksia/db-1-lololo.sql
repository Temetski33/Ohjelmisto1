--- Database hommia Ohjelmisto 1

--- Käyttäjän luonti
CREATE USER teemu@localhost IDENTIFIED BY "salakala";
--- Tuhotaan koko Ankkalinna ennen uuden luontia
DROP DATABASE ankkalinna;
--- Ankkalinnatietokannan luonti
